...
# Наборы: сколько разборов и сколько звёзд за них. Пятёрка дешевле на 5%,
# десятка — на 10%; тройка идёт без скидки, она для тех, кому просто
# удобнее заплатить один раз вместо трёх.
DISCOUNTS = ((1, 0), (3, 0), (5, 5), (10, 10))
